...
body.simple .solo-pro{display:none !important}
...
<div class="nav" id="nav">
  ...
  <button data-v="dash" class="solo-pro">F2 DASH</button>
  ...
  <button data-v="quant" class="solo-pro">F7 QUANT</button>
  <button data-v="brain" class="solo-pro">F8 CEREBRO</button>
  <button data-v="sim" class="solo-pro">F9 SIMULADOR</button>
  <button data-v="cart" class="solo-pro">F10 CARTERA</button>
  <button data-v="lib" class="solo-pro">F11 BIBLIOTECA</button>
  <div class="sp"></div>
...
<div class="view on" id="v-ini">
  ...
  <div class="p" style="padding:13px 16px">
    <div class="expl" style="color:var(--dim);font-size:11.5px">
      ...
      <span class="solo-pro"> · En modo completo tienes el detalle técnico de todo: F7 a F11.</span>
    </div>
  </div>
</div>
...
function aplicarModo(){
 ...
 // solo le anade ruido, y en modo sencillo la numeracion ademas salta huecos.
 [].forEach.call($("nav").querySelectorAll("button[data-v]"),function(b){
  if(!b.dataset.txt)b.dataset.txt=b.textContent;
  b.textContent=MODO==="simple"?b.dataset.txt.replace(/^F\\d+\\s+/,""):b.dataset.txt});
 // Si estabas en una vista avanzada y cambias a sencillo, te devuelve a la portada.
 if(MODO==="simple"&&["quant","brain","sim","cart","lib","dash"].indexOf(VIEW)>=0)go("ini");}
